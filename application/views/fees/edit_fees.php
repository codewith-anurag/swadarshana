...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <form method="POST" id="editpodcast" action="<?php echo base_url('fees/update/'.$edit_fees['id']) ?>"  enctype="multipart/form-data">
      <div class="card">            
          <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">                        
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control"><?php echo $edit_fees['description'] ?></textarea>
                                </div>
                            </div> 
                        </div>                       
                    </div>

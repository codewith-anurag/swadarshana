...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <form method="POST" id="addblog" action="<?php echo base_url('blog/insert') ?>"  enctype="multipart/form-data">
      <div class="card">            
          <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">                        
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="authername" class="form-control" placeholder="Blog Auther Name">
                                </div>
                            </div> 
                        </div> 
                        <div class="row">

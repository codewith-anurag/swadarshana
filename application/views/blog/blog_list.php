...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="page-header">
        ...
        <a class="nav-link float-right" href="<?php echo base_url('blog/add_blog') ?>">
            <span class="btn btn-primary btn-sm">+ Add Blog</span>
        </a>       
      </div>
       <div class="card">
          <div class="card-body">
            <table id="example" class="table table-striped table-bordered review_table " style="width:100%">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><img src="<?php echo base_url('assets/blogimage/').$blog_list["image"] ?>" height="200"></td>
                        <td><?php echo $blog_list["category"] ?></td>
                        <td><?php echo $blog_list["title"] ?></td>
                        <td><?php echo $blog_list["authername"] ?></td>                        
                        <td>
                            <a href="<?php echo base_url('blog/edit/'.$blog_list['id']) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>

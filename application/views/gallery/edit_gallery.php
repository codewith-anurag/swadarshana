...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <form method="POST" id="addslider" action="<?php echo base_url('gallery/update/'.$editgallery['id']) ?>"  enctype="multipart/form-data">
      <div class="card">            
          <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="old_galleryimage" value="<?php echo $editgallery['gallery_image'] ?>">
                            </div>                            
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="badge">Image</label>
                                <img src="<?php echo base_url('assets/galleryimage/').$editgallery['gallery_image'] ?>" height="400" width="400">                                
                            </div>                            
                        </div>
                    </div>
                </div>

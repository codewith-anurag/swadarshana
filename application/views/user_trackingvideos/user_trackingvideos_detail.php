            ...
            <table id="example" class="table table-striped table-bordered review_table " style="width:100%">
                ...
                <tbody>
                    ...
                    <?php 
                        ...
                        foreach ($tracking_detail as $tracking_detail_list) {    // print_r($tracking_detail);exit;

                    ?>

                    <tr>
                        <td><?php echo $tracking_detail_list["full_name"] ?></td>
                        <td><?php echo $tracking_detail_list["title"] ?></td>

                        <td> <a href="<?php echo base_url('assets/swashoppe_video/'.$tracking_detail_list["video"]); ?>" target="_blank" class="thumbnail1"><video width="150" height="120" muted="" loop="" class="swashoppevideo">
                                <source src="<?php echo base_url('assets/swashoppe_video/'.$tracking_detail_list["video"]); ?>" type="video/mp4">
                            </video></a>
                        </td>

                        <td><?php  
                            $seconds = floor($tracking_detail_list["total_duration"]);
                            $minutes = floor(($tracking_detail_list["total_duration"]  / 60) % 60);
                            $hours = floor($tracking_detail_list["total_duration"] / 3600);
                        ...
                        <td><?php
                            $strat_time_seconds = floor($tracking_detail_list["strat_time"]);
                            $strat_time_minutes = floor(($tracking_detail_list["strat_time"]  / 60) % 60);
                            $strat_time_hours = floor($tracking_detail_list["strat_time"] / 3600);
                        ...
                        ?></td> 
                        <td><?php 
                            $pause_time_seconds = floor($tracking_detail_list["pause_time"]);
                            $pause_time_minutes = floor(($tracking_detail_list["pause_time"]  / 60) % 60);
                            $pause_time_hours = floor($tracking_detail_list["pause_time"] / 3600);
                        ...
                        ?></td>
                        <!-- <td><?php 
                           /*$watching_duration_seconds = floor($tracking_detail_list["watching_duration"]);
                           $watching_duration_minutes = floor(($tracking_detail_list["watching_duration"]  / 60) % 60);
                           $watching_duration_hours = floor($tracking_detail_list["watching_duration"] / 3600);

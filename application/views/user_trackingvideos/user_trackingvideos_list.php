            ...
            <table id="example" class="table table-striped table-bordered review_table " style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ?></td>
                         <td><?php 
                           $watching_duration_seconds = floor($user_videos_list["total_watching_time"]);
                           $watching_duration_minutes = floor(($user_videos_list["total_watching_time"]  / 60) % 60);
                           $watching_duration_hours = floor($user_videos_list["total_watching_time"] / 3600);

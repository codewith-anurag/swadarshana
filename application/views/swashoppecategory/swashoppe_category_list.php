...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="page-header">
        ...
        <a class="nav-link float-right" href="<?php echo base_url('SwashoppeCategory/add_swashoppe_category') ?>">
            <span class="btn btn-primary btn-sm">+ Add Course</span>
        </a>       
      </div>
       <div class="card">
          <div class="card-body">
            <table id="example" class="table table-striped table-bordered review_table " style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th style="width:120px !important;">Course Banner</th>                                            
                        <th style="width:120px !important;">Action</th>                
                    </tr>
                </thead>
                <tbody>
                    <?php 
                        foreach ($albumcategory as $albumcategory_list) {                           
                    ?>
                    <tr>
                        <td><?php echo $albumcategory_list["title"] ?></td>
                        <td><?php echo $albumcategory_list["album_title"] ?></td>
                        <td><?php echo $albumcategory_list["price"] ?></td>
                        <td><img src="<?php echo base_url('assets/swashoppe_category_banner/'.$albumcategory_list['banner'])  ?>"></td>
                        <td>
                            <a href="<?php echo base_url('SwashoppeCategory/edit/'.$albumcategory_list['album_id']) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url('SwashoppeCategory/delete/'.$albumcategory_list['album_id']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>

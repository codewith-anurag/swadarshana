...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="page-header">
        ...
        <a class="nav-link float-right" href="<?php echo base_url('videotestimonial_category/add_video_testimonial_category') ?>">
            <span class="btn btn-primary btn-sm">+ Add Video Testimonial Category</span>
        </a>       
      </div>
       <div class="card">
          <div class="card-body">
            <table id="example" class="table table-striped table-bordered review_table " style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('videotestimonial_category/edit/'.$blogcategory_list['id']) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url('videotestimonial_category/delete/'.$blogcategory_list['id']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>

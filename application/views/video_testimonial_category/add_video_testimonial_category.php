...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <form method="POST" id="addblogcategory" action="<?php echo base_url('videotestimonial_category/insert') ?>"  enctype="multipart/form-data">
      <div class="card">            
          <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">                        
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category" class="form-control" placeholder="Enter Video Testimonial Category">
                                </div>
                            </div>  
                        </div>                                                                                            
                    </div>
